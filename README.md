...
- 角色阵亡复活后的完整任务衔接；换边已根据阵营、基地位置、地图尺寸和回合回退检测重置，仍需官方对局验证。

以上限制意味着 V1 已实现挖矿卖矿、建造维修升级及夜晚防守的规则流程，但还不会打任务系统这块最大的积分来源，也不会用进攻性道具主动清场。生存和经济流程已通过本地测试，实际对局效果待验证，等官方对局反馈后规划升级。
